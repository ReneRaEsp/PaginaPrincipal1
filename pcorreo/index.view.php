  				...
  				<div class="container-fluid d-flex justify-content-between">
    				...
    				<div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
      					<div class="navbar-nav d-flex justify-content-between">
    	    				...
    	    				<a class=" nav-link text-white font-weight-bold text-center" aria-current="page" href="https://renereaesp.github.io/pcontacto/index.html"><span class="p-2 h5">Contacto</span> <i class="fas fa-address-book"></i></a>
    	    				<a class=" nav-link text-white font-weight-bold text-center" aria-current="page" href="https://renereaesp.github.io/pportafolio/index.html"><span class="p-2 h5">Portfolio</span> <i class="fas fa-suitcase"></i></a>
